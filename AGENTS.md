...
- `plugins/ae3e-plotly-panel/` source currently lives at `/tmp/ae3e-plotly-panel/` in the build host. It needs to be pushed to a GitHub repo (pending username from the user) and ideally referenced as a git submodule in this repo.
