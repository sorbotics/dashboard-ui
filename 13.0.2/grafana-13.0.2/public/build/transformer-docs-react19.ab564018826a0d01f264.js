"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[3400],{84510(l,r,o){o.d(r,{ImageRenderType:()=>a,transformationDocsContent:()=>s});var a=(e=>(e.ShortcodeFigure="shortcodeFigure",e.UIImage="uiImage",e))(a||{});const s={calculateField:{name:"Add field from calculation",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/add-field-from-calc-stat-example-7-0.png",e,"A stat visualization including one field called Sum")}
...
This transformation allows you to flexibly adapt your data types, ensuring compatibility and consistency in your visualizations.
  `}},extractFields:{name:"Extract fields",getHelperDocs:function(e="shortcodeFigure"){return`
...
- **Format** - Choose one of the following:
  ...
  ${t("/media/docs/grafana/panels-visualizations/screenshot-regexp-detail-v11.3-2.png",e,"Example of a regular expression")}
...
This transformation lets you augment your data by fetching additional information from external sources, providing a more comprehensive dataset for analysis and visualization.
  `}},filterByRefId:{name:"Filter data by query refId",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/filter-by-query-stat-example-7-0.png",e,"A stat visualization with results from two queries, A and C")}
...
This versatile data filtering transformation lets you to selectively include or exclude data points based on specific conditions. Customize the criteria to tailor your data presentation to meet your unique analytical needs.
  `}},filterFieldsByName:{name:"Filter fields by name",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/filter-name-table-before-7-0.png",e,"A table visualization with time, value, Min, and Max columns")}

Here's the table after we applied the transformation to remove the Min field.

${t("/static/img/docs/transformations/filter-name-table-after-7-0.png",e,"A table visualization with time, value, and Max columns")}

Here is the same query using a Stat visualization.

${t("/static/img/docs/transformations/filter-name-stat-after-7-0.png",e,"A stat visualization with value and Max fields")}
...
Use this transformation to construct a matrix by specifying fields from your query results. The matrix output reflects the relationships between the unique values in these fields. This helps you present complex relationships in a clear and structured matrix format.
  `}},groupToNestedTable:{name:"Group to nested tables",getHelperDocs:function(e="shortcodeFigure"){return`
  ...
  ${t("/static/img/docs/transformations/nested-table-select-calculation.png",e,"A select box showing the Group and Calculate options for the transformation.")}
  ...
  ${t("/static/img/docs/transformations/nested-table-select-stat.png",e,"A select box showing available statistic calculations once the calculate option for the field has been selected.")}
...
Visualize the distribution of values using the generated histogram, providing insights into the data's spread and density.
  `}},joinByField:{name:"Join by field",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/join-fields-before-7-0.png",e,"A table visualization showing results for one server")}

I applied a transformation to join the query results using the time field. Now I can run calculations, combine, and organize the results in this new table.

${t("/static/img/docs/transformations/join-fields-after-7-0.png",e,"A table visualization showing results for multiple servers")}
...
This flexible transformation simplifies the process of consolidating and summarizing data from multiple time series into a more manageable and organized format.
  `}},renameByRegex:{name:"Rename by regex",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/media/docs/grafana/panels-visualizations/screenshot-rename-by-regex-before-v11.0.png",e,"A time series with full series names")}

With the transformation applied, you can see we are left with just the remainder of the string.

${t("/media/docs/grafana/panels-visualizations/screenshot-rename-by-regex-after-v11.0.png",e,"A time series with shortened series names")}
...
This transformation allows you to manipulate and analyze geospatial data, enabling operations such as creating lines between points, calculating spatial properties, and more.
  `}},timeSeriesTable:{name:"Time series to table transform",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/table-sparklines.png",e,"A table panel showing multiple values and their corresponding sparklines.")}
...
${t("/static/img/docs/transformations/timeseries-table-select-stat.png",e,"A select box showing available statistics that can be calculated.")}
...
> **Note:** This transformation is available in Grafana 9.5+ as an opt-in beta feature. Modify the Grafana [configuration file][] to use it.
  `},links:[{title:"sparkline cell type",url:"https://grafana.com/docs/grafana/latest/panels-visualizations/visualizations/table/#sparkline"},{title:"configuration file",url:"https://grafana.com/docs/grafana/latest/setup-grafana/configure-grafana/"}]},transpose:{name:"Transpose",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/media/docs/grafana/transformations/screenshot-grafana-11-2-transpose-transformation.png",e,"Before and after transpose transformation")}
  `}},regression:{name:"Trendline",getHelperDocs:function(e="shortcodeFigure"){return`
...
${t("/static/img/docs/transformations/linear-regression.png",e,"A time series visualization with a straight line representing the linear function")}
- **Polynomial** - Fits a polynomial function to the data.
${t("/static/img/docs/transformations/polynomial-regression.png",e,"A time series visualization with a curved line representing the polynomial function")}

> **Note:** This transformation was previously called regression analysis.
  `}},smoothing:{name:"Smoothing",getHelperDocs:function(e="shortcodeFigure"){return`
...
The transformation preserves all original time points while reducing noise, resulting in smoother curves that maintain continuous lines without gaps.
  `}}};function t(e,n,i){return n==="shortcodeFigure"?`{{< figure src="${e}" class="docs-image--no-shadow" max-width= "1100px" alt="${i}" >}}`:`![${i}](https://grafana.com${e})`}}}]);

//# sourceMappingURL=transformer-docs-react19.ab564018826a0d01f264.js.map