...
func (hs *HTTPServer) GetHomeDashboard(c *contextmodel.ReqContext) response.Response {
	...
	// If a custom default home dashboard path is configured, use it directly
	// and skip user preferences. This allows deployments to enforce a specific
	// home dashboard regardless of per-user settings.
