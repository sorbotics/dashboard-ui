...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('react-router'), require('@remix-run/router'), require('history'), require('react-router-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'react-router', '@remix-run/router', 'history', 'react-router-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactRouterDOMv5Compat = {}, global.React, global.ReactDOM, global.ReactRouter, global.RemixRouter, global.HistoryLibrary, global.ReactRouterDOM));
})(this, (function (exports, React, ReactDOM, reactRouter, router, history, reactRouterDom) { 'use strict';
  ...
  */
  ...
  const useIsomorphicLayoutEffect = canUseEffectHooks ? React__namespace.useLayoutEffect : () => {};
  function CompatRouter(_ref) {
    ...
    return /*#__PURE__*/React__namespace.createElement(reactRouter.Router, {
      ...
      location: state.location,
      navigator: history
    }, /*#__PURE__*/React__namespace.createElement(reactRouter.Routes, null, /*#__PURE__*/React__namespace.createElement(reactRouter.Route, {
      path: "*",
      element: children
    })));
  }
  ...
  function StaticRouter(_ref2) {
    ...
    let staticNavigator = {
      ...
      encodeLocation(to) {
        let href = typeof to === "string" ? to : history.createPath(to);
