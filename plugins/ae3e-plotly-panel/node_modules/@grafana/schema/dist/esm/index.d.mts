 ...
 */
interface TableActionsCellOptions {
 ...
 */
type TableCellOptions = (TableAutoCellOptions | TableSparklineCellOptions | TableBarGaugeCellOptions | TableColoredBackgroundCellOptions | TableColorTextCellOptions | TableImageCellOptions | TableDataLinksCellOptions | TableActionsCellOptions | TableJsonViewCellOptions);
/**
...
interface TimePickerConfig$1 {
     ...
     */
    quick_ranges?: Array<TimeOption$1>;
    /**
...
interface TimeOption extends TimeOption$1 {
}
...
export { type AnnotationContainer, type AnnotationPanelFilter, type AnnotationQuery, type AnnotationTarget, AxisColorMode, type AxisConfig, AxisPlacement, BarAlignment, type BarConfig, BarGaugeDisplayMode, BarGaugeNamePlacement, BarGaugeSizing, BarGaugeValueMode, type BaseDimensionConfig, BigValueColorMode, BigValueGraphMode, BigValueJustifyMode, BigValueTextMode, type ColorDimensionConfig, ComparisonOperation, type CookiePreferences, type Dashboard, DashboardCursorSync, type DashboardLink, type DashboardLinkType, type DataQuery, type DataSourceJsonData, type DataSourceRef$1 as DataSourceRef, DataTopic, type DataTransformerConfig, type FieldColor, FieldColorModeId, type FieldColorSeriesByMode, type FieldConfig, type FieldConfigSource, type FieldTextAlignment, type FillConfig, type FrameGeometrySource, FrameGeometrySourceMode, GraphDrawStyle, type GraphFieldConfig, GraphGradientMode, type GraphThresholdsStyleConfig, GraphThresholdsStyleMode, GraphTransform, type GridPos, type HeatmapCalculationBucketConfig, HeatmapCalculationMode, type HeatmapCalculationOptions, HeatmapCellLayout, type HideSeriesConfig, type HideableFieldConfig, type Labels, LegendDisplayMode, type LegendPlacement, type LibraryElementDTOMeta, type LibraryElementDTOMetaUser, type LibraryPanel, type LibraryPanelRef, type LineConfig, LineInterpolation, type LineStyle, LoadingState, LogsDedupStrategy, LogsSortOrder, type MapLayerOptions, MappingType, type MatcherConfig, type NavbarPreference, type OptionsWithLegend, type OptionsWithTextFormatting, type OptionsWithTimezones, type OptionsWithTooltip, type Panel, PercentChangeColorMode, type PointsConfig, type Preferences, type PublicDashboard, type QueryHistoryPreference, type RangeMap, type ReduceDataOptions, type RegexMap, type ResourceDimensionConfig, ResourceDimensionMode, type RowPanel, type ScalarDimensionConfig, ScalarDimensionMode, type ScaleDimensionConfig, ScaleDimensionMode, ScaleDirection, ScaleDistribution, type ScaleDistributionConfig, ScaleOrientation, type SingleStatBaseOptions, SortOrder, type SpecialValueMap, SpecialValueMatch, type StackableFieldConfig, type StackingConfig, StackingMode, type TableActionsCellOptions, type TableAutoCellOptions, type TableBarGaugeCellOptions, TableCellBackgroundDisplayMode, TableCellDisplayMode, TableCellHeight, type TableCellOptions, type TableColorTextCellOptions, type TableColoredBackgroundCellOptions, type TableDataLinksCellOptions, type TableFieldOptions, type TableFooterOptions, type TableImageCellOptions, type TableJsonViewCellOptions, type TableSortByFieldState, type TableSparklineCellOptions, type TextDimensionConfig, TextDimensionMode, type Threshold, type ThresholdsConfig, ThresholdsMode, type TimeOption, type TimePickerConfig, type TimeZone, type TimeZoneBrowser, type TimeZoneUtc, type TimelineValueAlignment, TooltipDisplayMode, type ValueMap, type ValueMapping, type ValueMappingResult, VariableFormatID, VariableHide, type VariableModel, type VariableOption, VariableRefresh, VariableSort, type VariableType, VisibilityMode, type VizLegendOptions, VizOrientation, type VizTextDisplayOptions, type VizTooltipOptions, defaultAnnotationContainer, defaultAnnotationPanelFilter, defaultAnnotationQuery, defaultAnnotationTarget, defaultDashboard, defaultDashboardCursorSync, defaultDashboardLink, defaultFieldConfig, defaultFieldConfigSource, defaultGridPos, defaultLineStyle, defaultMatcherConfig, defaultNavbarPreference, defaultOptionsWithTimezones, defaultPanel, defaultReduceDataOptions, defaultRowPanel, defaultTableFieldOptions, defaultTableFooterOptions, defaultThresholdsConfig, defaultTimePickerConfig, defaultTimeZone, defaultVariableModel, defaultVizLegendOptions };
