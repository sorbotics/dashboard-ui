...
export declare const pluginVersion = "11.6.17";
...
export declare const defaultFiltersSettings: Partial<FiltersSettings>;
...
export declare const defaultPipelineMetricAggregationWithMultipleBucketPaths: Partial<PipelineMetricAggregationWithMultipleBucketPaths>;
...
export declare const defaultElasticsearchDataQuery: Partial<ElasticsearchDataQuery>;
