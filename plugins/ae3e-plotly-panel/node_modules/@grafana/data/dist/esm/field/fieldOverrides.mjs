import { cloneDeep, unset, set, isNumber, get } from 'lodash';
import { useRef, useMemo } from 'react';
import usePrevious from 'react-use/lib/usePrevious';
import { VariableFormatID, ThresholdsMode } from '@grafana/schema';
import { compareArrayValues, compareDataFrameStructures } from '../dataframe/frameComparisons.mjs';
import { guessFieldTypeForField } from '../dataframe/processDataFrame.mjs';
import { asHexString } from '../themes/colorManipulator.mjs';
import { ReducerID, reduceField } from '../transformations/fieldReducer.mjs';
import { fieldMatchers } from '../transformations/matchers.mjs';
import { FieldType } from '../types/dataFrame.mjs';
import { FieldColorModeId } from '../types/fieldColor.mjs';
import { mapInternalLinkToExplore } from '../utils/dataLinks.mjs';
import { locationUtil } from '../utils/location.mjs';
import { getDisplayProcessor, getRawDisplayProcessor } from './displayProcessor.mjs';
import { getMinMaxAndDelta } from './scale.mjs';
import { standardFieldConfigEditorRegistry } from './standardFieldConfigEditorRegistry.mjs';
...
function setFieldConfigDefaults(config, defaults, context) {
  ...
  const defaultBaseStep = ((_a = defaults == null ? void 0 : defaults.thresholds) == null ? void 0 : _a.mode) === ThresholdsMode.Absolute && ((_b = defaults.thresholds) == null ? void 0 : _b.steps.find((step) => step.value === -Infinity));
  if (((_c = config.thresholds) == null ? void 0 : _c.mode) === ThresholdsMode.Absolute && !config.thresholds.steps.some((step) => step.value === -Infinity) && defaultBaseStep) {
...
export { applyFieldOverrides, applyRawFieldOverrides, findNumericFieldMinMax, getFieldDataContextClone, getLinksSupplier, setDynamicConfigValue, setFieldConfigDefaults, useFieldOverrides, validateFieldConfig };
//# sourceMappingURL=fieldOverrides.mjs.map
