...
import { VizLayout } from '../../components/VizLayout/VizLayout.mjs';
import { UPlotChart } from '../../components/uPlot/Plot.mjs';
import { pluginLog, findMidPointYPosition } from '../../components/uPlot/utils.mjs';
import { preparePlotFrame } from './utils.mjs';
...
class GraphNG extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx(VizLayout, { width, height, legend: renderLegend(config), children: (vizWidth, vizHeight) => /* @__PURE__ */ jsx(
      UPlotChart,
      {
        config,
        data: alignedData,
...
export { GraphNG };
//# sourceMappingURL=GraphNG.mjs.map
