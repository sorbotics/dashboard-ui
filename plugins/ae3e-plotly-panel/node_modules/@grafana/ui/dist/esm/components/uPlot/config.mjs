import { GraphThresholdsStyleMode, StackingMode, GraphGradientMode, AxisPlacement, VisibilityMode, BarAlignment, LineInterpolation, GraphDrawStyle } from '@grafana/schema';
