...
import { ThresholdsMode, VizOrientation, GAUGE_DEFAULT_MINIMUM, GAUGE_DEFAULT_MAXIMUM, FALLBACK_COLOR, formattedValueToString, getFieldColorMode, FieldColorModeId } from '@grafana/data';
import { selectors } from '@grafana/e2e-selectors';
import { BarGaugeDisplayMode, BarGaugeValueMode, BarGaugeNamePlacement } from '@grafana/schema';
import { measureText, calculateFontSize } from '../../utils/measureText.mjs';
...
class BarGauge extends PureComponent {
  render() {
    ...
    return /* @__PURE__ */ jsxs("div", { style: styles.wrapper, className, children: [
  ...
  renderBasicAndGradientBars() {
    ...
    return /* @__PURE__ */ jsxs("div", { style: styles.wrapper, children: [
      valueDisplayMode !== BarGaugeValueMode.Hidden && /* @__PURE__ */ jsx(
      ...
      showUnfilled && /* @__PURE__ */ jsx("div", { style: styles.emptyBar }),
  ...
  renderRetroBars() {
    ...
    for (let i = 0; i < cellCount; i++) {
      ...
      cells.push(/* @__PURE__ */ jsx("div", { style: cellStyles }, i.toString()));
    }
...
//# sourceMappingURL=BarGauge.mjs.map
