...
import { FIXED_UNIT } from './types.mjs';
...
function buildScaleKey$1(config, fieldType) {
  ...
  const scaleDistribution = ((_f = config.custom) == null ? void 0 : _f.scaleDistribution) ? getScaleDistributionPart$1(config.custom.scaleDistribution) : ScaleDistribution.Linear;
...
export { buildScaleKey$1 as buildScaleKey };
